    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void addClassView(String classCode, String subjectName, String yearSection) {
            try {
                ...
                cardLayout.setBackgroundResource(R.drawable.card_background); // Add a rounded background drawable
                ...
                iconView.setLayoutParams(new LinearLayout.LayoutParams(50, 50));
                iconView.setPadding(8, 8, 8, 8);
                cardLayout.addView(iconView);

                LinearLayout textLayout = new LinearLayout(this);
                textLayout.setOrientation(LinearLayout.VERTICAL);
                textLayout.setPadding(16, 0, 0, 0); // Add padding between icon and text
                ...
                yearSectionText.setTextSize(18); // Larger text
                yearSectionText.setTypeface(null, Typeface.BOLD); // Bold text
                yearSectionText.setTextColor(Color.WHITE); // Set text color to white
                ...
                classCodeText.setTextSize(14); // Same size as subject name
                classCodeText.setTextColor(Color.LTGRAY); // Set text color to light gray
                ...
                subjectNameText.setTextSize(14); // Smaller text
                subjectNameText.setTextColor(Color.LTGRAY); // Set text color to light gray
