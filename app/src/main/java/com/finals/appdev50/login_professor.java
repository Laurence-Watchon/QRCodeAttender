...
public class login_professor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgotpassword.setOnClickListener(v -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(login_professor.this);
                ...
                public void onClick(View view) {
                    try {
                        ...
                        if (TextUtils.isEmpty(useremail) || !Patterns.EMAIL_ADDRESS.matcher(useremail).matches()) {
                            Toast.makeText(login_professor.this, "Enter your Valid Email Address", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        mAuth.sendPasswordResetEmail(useremail).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(login_professor.this, "Check your Email inbox or Spam", Toast.LENGTH_SHORT).show();
                                    dialog.dismiss();
                                } else {
                                    Toast.makeText(login_professor.this, "Unable to send email, Failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    } catch (Exception ex){
                        Toast.makeText(login_professor.this, "Error: " + ex.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }
            });
        ...
        login.setOnClickListener(v -> {
            ...
            try{
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                            ...
                                            mDatabase.child("Registered Users").child(uid).child("role").addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    if (snapshot.exists()) {
                                                        ...
                                                        if (userRole != null && userRole.equalsIgnoreCase("Professor")) {
                                                            SharedPreferences sharedPreferences = getSharedPreferences("UserPrefs", MODE_PRIVATE);
                                                            SharedPreferences.Editor editor = sharedPreferences.edit();
                                                            editor.putString("userRole", userRole);  // Save role in SharedPreferences
                                                            editor.apply();

                                                            Intent intent2 = new Intent(getApplicationContext(), HomepageProfessor.class);
                                                            startActivity(intent2);
                                                            finish();
                                                        } else {
                                                            mAuth.signOut();
                                                            Toast.makeText(login_professor.this, "Please make sure you're logging in as a Professor", Toast.LENGTH_SHORT).show();
                                                        }
                                                    } else {
                                                        Toast.makeText(login_professor.this, "User type not found in the database", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(login_professor.this, "Authentication failed.",
                ...
                Toast.makeText(login_professor.this, "Error: " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
